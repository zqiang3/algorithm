import struct
import traceback
from read_data import read_data_str
...
def test_sort_func(func, input_file, output_file):
    arr = read_data_str(input_file)
    func(arr)
    write_result(output_file, arr)

        
test_sort_func(qsort_v2, 'numbers.txt', 'result1')
